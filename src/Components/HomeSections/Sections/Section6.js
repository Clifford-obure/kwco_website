...
const Section6 = () => {
  ...
  return (
    <div className="w-full container mx-auto flex flex-col gap-5 md:gap-8 py-8 px-4 md:px-8">
      <motion.div
        className="w-full text-[#2F4B79] space-y-6"
      ...
      >
        ...
        <form
          className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 rounded-md shadow-md"
      ...
      <div className="w-full">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15955.038034974563!2d36.7831592!3d-1.2920658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f173b24e3a7a9%3A0x5a0c8e82a94e35ff!2sNine%20Planets%20Apartments%2C%20Suite%20Pluto%20(P4)%2C%20Opp.%20Sudan%20Embassy%2C%20Kabarnet%20Gardens%2C%20Nairobi!5e0!3m2!1sen!2ske!4v1718913085910!5m2!1sen!2ske"
          width="100%"
          height="500"
          style={{ border: 0 }}
          allowFullScreen=""
