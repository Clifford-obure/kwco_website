...
import banner1 from "./../assets/banners/sk_banner2.jpg"; // Update with actual filenames
import banner2 from "./../assets/banners/sk_banner4.jpg";
import banner3 from "./../assets/banners/sk_banner3.jpg";
// Add more banner imports as needed
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <button
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/50 text-white p-2 rounded-full hover:bg-black/70 transition"
        ...
        <button
          onClick={goToNext}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/50 text-white p-2 rounded-full hover:bg-black/70 transition"
